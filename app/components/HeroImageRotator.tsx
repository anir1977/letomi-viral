...
const slides = [
  {
    src: "https://images.unsplash.com/photo-1503676260728-1c00da094a0b?w=1600&h=900&fit=crop&auto=format&q=75",
    alt: "Person thinking while looking at notes",
    caption: "Human curiosity: thinking through a new idea",
  },
  {
    src: "https://images.unsplash.com/photo-1524995997946-a1c2e315a42f?w=1600&h=900&fit=crop&auto=format&q=75",
    alt: "Old manuscript with handwritten notes",
    caption: "Ancient manuscripts that shaped knowledge",
  },
  {
    src: "https://images.unsplash.com/photo-1504384308090-c894fdcc538d?w=1600&h=900&fit=crop&auto=format&q=75",
...
export default function HeroImageRotator() {
  ...
  return (
    <div className="absolute inset-0" aria-live="polite">
      ...
      <div className="absolute bottom-6 left-6 z-20 max-w-xs min-h-[64px] rounded-2xl bg-black/40 px-4 py-3 text-sm text-white backdrop-blur-md shadow-lg">
